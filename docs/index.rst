.. django-context-extras documentation master file, created by
   sphinx-quickstart on Sun Nov 14 09:50:21 2010.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

=========================
django-context-extras's documentation
=========================
...
Welcome to the *django-context-extras*'s documentation!
...
| **Source Code Repository**: `django-context-extras source code <https://source.codetrax.org/hgroot/django-context-extras>`_
| **Documentation**: `django-context-extras documentation <http://packages.python.org/django-context-extras>`_
| **Downloads**: `django-context-extras releases <http://pypi.python.org/pypi/django-context-extras>`_


About this guide
================

This guide provides an introduction to the *django-context-extras* |version| release,
